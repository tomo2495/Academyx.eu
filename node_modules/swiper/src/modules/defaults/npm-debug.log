...
7 silly cache add   spec: '/Users/vladimirkharlampidi/GitHub/Swiper/src/modules/defaults',
7 silly cache add   type: 'local' }
8 error addLocal Could not install /Users/vladimirkharlampidi/GitHub/Swiper/src/modules/defaults
9 verbose stack Error: EISDIR: illegal operation on a directory, read
9 verbose stack     at Error (native)
10 verbose cwd /Users/vladimirkharlampidi/GitHub/Swiper/src/modules/defaults
11 error Darwin 16.7.0
12 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "publish" "./"
13 error node v6.7.0
14 error npm  v3.10.3
